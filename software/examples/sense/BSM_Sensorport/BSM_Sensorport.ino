...
void loop()
{
  int fadeAmount = analogRead(SENSORPORT); //Read the Value of the SENSORPORT and save it to the integer variable fadeAmount
  analogWrite(LED_01, fadeAmount); //Write fadeAmount to the LED_01 Pin, fading in and out LED_01 based on the value measured.
}
